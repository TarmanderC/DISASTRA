...
public class DialogueResponseEvents : MonoBehaviour
{
    ...
    {
        // Find the DialogueActivator linked to this dialogue
        DialogueActivator activator = GetComponent<DialogueActivator>();
        if (activator != null)
        {
            activator.DisableDialogue(); // Disable further interactions
        }
    }
